...
// 
// db.StudDetails.insert({_id:1,name:'ABC',rollNo:11,age:20,contactNo:'0123456789', emailId:'abc@gmail.com'});
// db.StudDetails.insert({_id:2,name:'XYZ',rollNo:10,age:21,contactNo:'0123456779', emailId:'xyz@gmail.com'});
// db.StudDetails.insert({_id:3,name:'MNO',rollNo:20,age:22,contactNo:'0123463789', emailId:'mno@gmail.com'});
// db.StudDetails.insert({_id:4,name:'PQR',rollNo:30,age:23,contactNo:'0122556789', emailId:'pqr@gmail.com'});
// db.StudDetails.find({})
